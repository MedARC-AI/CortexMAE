...
configs=(
    d4_c512_h16_1/patch/attn
    d2_c512_h16_1/patch/attn
    d8_c512_h16_1/patch/attn
    d12_c512_h16_1/patch/attn
    d4_c768_h12_1/patch/attn
)
...
notes="decoder_depth ablation $key; eval v2 (${dataset} ${repr} ${clf})"
